...
import com.myuan.web.service.CollectionService;
...
public class CollectionController {
    ...
    @DeleteMapping("post/{cid}/user/{uid}")
    ...
    @GetMapping("collections/user/{id}")
