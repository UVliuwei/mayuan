...
;layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var e = this, i = e.config,
            ...
            o = i.elem.next();
        (o.hasClass(u) || o.hasClass(c)) && o.remove(), a.ie && a.ie < 10 && i.elem.wrap('<div class="layui-upload-wrap"></div>'), e.isFile()
            ? (e.elemFile = i.elem, i.field = i.elem[0].name) : i.elem.after(n), a.ie && a.ie < 10 && e.initIE()
    }, p.prototype.initIE = function () {
        var e = this, i = e.config, n = t('<iframe id="' + f + '" class="' + f + '" name="' + f + '" frameborder="0"></iframe>'), a = t(
            ['<form target="' + f + '" class="' + c + '" method="' + i.method,
                '" key="set-mine" enctype="multipart/form-data" action="' + i.url + '">', "</form>"].join(""));
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            var i = 0, n = 0, a = e || o.files || o.chooseFiles || r.files, u = function () {
                l.multiple && i + n === o.fileLength && "function" == typeof l.allDone && l.allDone({total: o.fileLength, successful: i, aborted: n})
            };
            layui.each(a, function (e, a) {
                ...
                r.append(l.field, a), layui.each(l.data, function (e, t) {
                    ...
                    url: l.url, type: l.method, data: r, contentType: !1, processData: !1, dataType: "json", success: function (t) {
                        i++, d(e, t), u()
                    }, error: function () {
        ...
        var e = this, i = e.config, o = function (t) {
            ...
            a.next().hasClass(s) && a.next().remove(), e.upload(null, "choose"), e.isFile() || i.choose || a.after('<span class="layui-inline ' + s
                + '">' + o + "</span>")
        };
